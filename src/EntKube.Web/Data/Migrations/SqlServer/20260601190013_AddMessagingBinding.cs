        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RabbitMQClusterId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AppDeploymentId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Vhost = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    QueueName = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    ExchangeName = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
