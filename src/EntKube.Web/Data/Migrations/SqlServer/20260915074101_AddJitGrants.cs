        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TicketRef = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    ...
                    DeniedBy = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    ...
                    ServiceAccountName = table.Column<string>(type: "nvarchar(63)", maxLength: 63, nullable: true),
                    TokenHash = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    DisplayPrefix = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: true),
                    TokenExpiresAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastUsedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    EncryptedClusterToken = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    ClusterTokenNonce = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    ClusterTokenKey = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    ClusterTokenKeyNonce = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    TornDownAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
