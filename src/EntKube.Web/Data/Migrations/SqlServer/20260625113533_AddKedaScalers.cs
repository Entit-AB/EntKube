        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScaleTargetName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ScaleTargetKind = table.Column<string>(type: "nvarchar(63)", maxLength: 63, nullable: false),
                    MinReplicaCount = table.Column<int>(type: "int", nullable: true),
                    MaxReplicaCount = table.Column<int>(type: "int", nullable: true),
                    PollingInterval = table.Column<int>(type: "int", nullable: true),
                    CooldownPeriod = table.Column<int>(type: "int", nullable: true),
                    TriggersYaml = table.Column<string>(type: "nvarchar(max)", nullable: true),
