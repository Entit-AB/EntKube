        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KafkaVersion = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                    ...
                    AuthEnabled = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    KafkaClusterId = table.Column<Guid>(type: "TEXT", nullable: false),
                    TenantId = table.Column<Guid>(type: "TEXT", nullable: false),
                    Name = table.Column<string>(type: "TEXT", maxLength: 249, nullable: false),
                    Partitions = table.Column<int>(type: "INTEGER", nullable: false),
                    Replicas = table.Column<int>(type: "INTEGER", nullable: false),
                    RetentionMs = table.Column<long>(type: "INTEGER", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProducerTopics = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    ConsumerTopics = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    ConsumerGroup = table.Column<string>(type: "TEXT", maxLength: 255, nullable: true),
                    SuperUser = table.Column<bool>(type: "INTEGER", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantId = table.Column<Guid>(type: "TEXT", nullable: false),
                    KafkaUserId = table.Column<Guid>(type: "TEXT", nullable: true),
