        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PortName = table.Column<string>(type: "TEXT", maxLength: 63, nullable: true),
                    AppProtocol = table.Column<string>(type: "TEXT", maxLength: 30, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PeerType = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                    PeerAppId = table.Column<Guid>(type: "TEXT", nullable: true),
                    PeerNamespace = table.Column<string>(type: "TEXT", maxLength: 63, nullable: true),
                    PeerSelector = table.Column<string>(type: "TEXT", nullable: true),
                    PeerCidr = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
