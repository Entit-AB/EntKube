        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BaseDn = table.Column<string>(type: "TEXT", maxLength: 400, nullable: false),
                    ...
                    StartTlsEnabled = table.Column<bool>(type: "INTEGER", nullable: false),
                    ReplicationEnabled = table.Column<bool>(type: "INTEGER", nullable: false),
                    ReplicaCount = table.Column<int>(type: "INTEGER", nullable: false),
                    MemberOfEnabled = table.Column<bool>(type: "INTEGER", nullable: false),
                    RefIntEnabled = table.Column<bool>(type: "INTEGER", nullable: false),
                    PasswordPolicyEnabled = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    ConfigId = table.Column<Guid>(type: "TEXT", nullable: false),
                    OrganizationalUnitId = table.Column<Guid>(type: "TEXT", nullable: true),
                    Cn = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    Description = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    GroupType = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cn = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    Sn = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    GivenName = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    Email = table.Column<string>(type: "TEXT", maxLength: 320, nullable: true),
                    DisplayName = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    UidNumber = table.Column<int>(type: "INTEGER", nullable: true),
                    GidNumber = table.Column<int>(type: "INTEGER", nullable: true),
                    HomeDirectory = table.Column<string>(type: "TEXT", maxLength: 400, nullable: true),
                    LoginShell = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    IsServiceAccount = table.Column<bool>(type: "INTEGER", nullable: false),
                    PasswordSsha = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
