        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BaseDn = table.Column<string>(type: "character varying(400)", maxLength: 400, nullable: false),
                    ...
                    LdapsPort = table.Column<int>(type: "integer", nullable: false),
                    ...
                    StartTlsEnabled = table.Column<bool>(type: "boolean", nullable: false),
                    ReplicationEnabled = table.Column<bool>(type: "boolean", nullable: false),
                    ReplicaCount = table.Column<int>(type: "integer", nullable: false),
                    MemberOfEnabled = table.Column<bool>(type: "boolean", nullable: false),
                    RefIntEnabled = table.Column<bool>(type: "boolean", nullable: false),
                    PasswordPolicyEnabled = table.Column<bool>(type: "boolean", nullable: false),
                    PpolicyMinLength = table.Column<int>(type: "integer", nullable: false),
                    PpolicyMaxFailure = table.Column<int>(type: "integer", nullable: false),
                    PpolicyLockoutDurationSeconds = table.Column<int>(type: "integer", nullable: false),
                    PpolicyMaxAgeDays = table.Column<int>(type: "integer", nullable: false),
                    PpolicyInHistory = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OpenLdapComponentConfigs_ClusterComponents_ClusterComponent~",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OpenLdapOrganizationalUnits_OpenLdapComponentConfigs_Config~",
                        column: x => x.ConfigId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cn = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    Description = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    GroupType = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    GidNumber = table.Column<int>(type: "integer", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OpenLdapGroups_OpenLdapOrganizationalUnits_OrganizationalUn~",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DisplayName = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    UidNumber = table.Column<int>(type: "integer", nullable: true),
                    GidNumber = table.Column<int>(type: "integer", nullable: true),
                    HomeDirectory = table.Column<string>(type: "character varying(400)", maxLength: 400, nullable: true),
                    LoginShell = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    IsServiceAccount = table.Column<bool>(type: "boolean", nullable: false),
                    PasswordSsha = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OpenLdapUsers_OpenLdapOrganizationalUnits_OrganizationalUni~",
                        column: x => x.OrganizationalUnitId,
                        principalTable: "OpenLdapOrganizationalUnits",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
