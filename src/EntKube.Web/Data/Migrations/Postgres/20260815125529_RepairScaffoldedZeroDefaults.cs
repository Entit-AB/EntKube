...
namespace EntKube.Web.Data.Migrations.Postgres
{
    ...
    public partial class RepairScaffoldedZeroDefaults : Migration
    {
        ...
        {
            // Identifiers are quoted throughout: EF creates them in PascalCase, and an unquoted
            // reference would be folded to lower case and fail to resolve.
            ...
            // CreatedAt is "timestamp with time zone"; the literal is pinned to UTC so the
            // comparison does not depend on the session TimeZone setting.
            migrationBuilder.Sql("""
                UPDATE "VpnTunnels"
                SET "IkeLifetime" = 86400
                WHERE "IkeLifetime" = 0
                  AND "CreatedAt" < TIMESTAMPTZ '2026-06-02 10:34:42Z';
                """);
