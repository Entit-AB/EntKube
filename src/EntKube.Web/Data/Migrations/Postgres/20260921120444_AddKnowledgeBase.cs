        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HandlesPatientData = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OfficeHoursOnly = table.Column<bool>(type: "boolean", nullable: false),
                    ContactRoute = table.Column<string>(type: "text", nullable: true),
                    CriticalPath = table.Column<bool>(type: "boolean", nullable: false),
                    Notes = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EndOfLifeOn = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ProposedUpgrade = table.Column<string>(type: "text", nullable: true),
                    NoticeGivenAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    NoticeGivenBy = table.Column<string>(type: "text", nullable: true),
                    UpgradeOrderedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    UpgradedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    Notes = table.Column<string>(type: "text", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
