...
namespace EntKube.Web.Data.Migrations.Postgres
{
    ...
    public partial class AddClusterKubeconfigVault : Migration
    {
        ...
        {
            // NOTE: the legacy plaintext "Kubeconfig" column is intentionally NOT dropped here.
            ...
            // has been migrated. Dropping it in the migration would destroy that data before backfill.
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            // The legacy "Kubeconfig" column is dropped out-of-band by the startup backfill,
            // not by Up(), so there is nothing to restore here.
        }
    }
}
