...
/// Keys are opaque paths (e.g. <c>logs/2026/07/07/&lt;guid&gt;.zip</c>); values are whole files (a zipped
/// Lucene index directory), uploaded and downloaded as complete objects.
/// </summary>
