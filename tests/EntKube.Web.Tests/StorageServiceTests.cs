...
public class StorageServiceTests : IDisposable
{
    ...
    public StorageServiceTests()
    {
        ...
        OpenStackKeystoneClient keystone = new(httpFactory, vaultService);
        ...
        sut = new StorageService(dbFactory, vaultService, openStackS3, keystone, new Mock<IKubernetesClientFactory>().Object, storageClientFactory);
    }
    ...
    public async Task DeleteOpenStackConnectionAsync_RemovesConnectionAndVaultSecrets()
    {
        ...
        OpenStackConnection connection = await sut.CreateOpenStackConnectionAsync(
            ...
            "Sto2", null, null, null, null, "user", "pass123", null, null, null);
    ...
    public async Task DeleteOpenStackConnectionAsync_WithLinkedStorage_ReturnsFalse()
    {
        ...
        OpenStackConnection connection = await sut.CreateOpenStackConnectionAsync(
            ...
            "Kna1", null, null, null, null, null, null, null, null, null);
